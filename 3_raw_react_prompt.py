...
# Change 2/3: Delete JSON schemas. Tools now ling inside the prompt as plain text. 
...
react_prompt = f"""
"STRICT RULES - you must follow t hese exactly:
1. NEVER guess or assume any product price. You MUST call get_product_price first to get the real price.
2. Only call the apply_discount AFTER you have received a price from get_product_price. Pass the exact price returned by get_product_price - do NOT pass a made-up number."
...
def run_agent(question: str):
    ...
    for iteration in range(1, MAX_ITERATIONS + 1):
        ...
        # Split comma-separated arge; strip : prefix if LLM outputs key: value format
        ...
        # Change 7" History is on growing string re-sent ever iteration (replaces messages.append)
...
if __name__ == "__main__":
    ...
    results = run_agent("What is the price of a laptop after applying the gold discount?")
